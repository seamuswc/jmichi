...
export async function sendPromoCodeEmail(data: PromoCodeEmailData): Promise<boolean> {
  try {
    ...
    const sender = process.env.TENCENT_SES_SENDER || 'data@jmichi.com';
    ...
    const request = {
      ...
      Template: {
        TemplateID: parseInt(process.env.TENCENT_SES_TEMPLATE_ID_PROMO || '67034'),
    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="info-box">
                ...
                <p><strong>Website:</strong> https://jmichi.com/data</p>
...
📧 Note: If you don't see this email, please check your spam folder.`;
    ...
    const request = {
      ...
      Template: {
        TemplateID: parseInt(process.env.TENCENT_SES_TEMPLATE_ID_DATA || '67035'),
        TemplateData: JSON.stringify({
          email: data.email,
          password: data.password,
