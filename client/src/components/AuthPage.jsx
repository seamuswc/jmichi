        ...
        {cityData && (
          <div className="bg-blue-50 p-4 rounded-lg mb-6">
            ...
            <div className="grid grid-cols-1 gap-4 text-center">
              <div>
                <p className="text-2xl font-bold text-blue-900">{cityData.japan || 0}</p>
                <p className="text-sm text-blue-700">Japan</p>
              </div>
            </div>
          </div>
        )}
          ...
          <div className="space-y-4">
            ...
            <div className="bg-yellow-50 border border-yellow-200 p-3 rounded-lg">
              <p className="text-sm text-yellow-800">
                ...
                <strong>Password:</strong> Generated automatically<br/>
                <strong>📧 Email:</strong> Login details will be sent to your email address. Please check your spam folder if you don't see it within a few minutes.<br/>
                <strong>📧 メール:</strong> ログイン詳細はメールアドレスに送信されます。数分以内に届かない場合は、スパムフォルダをご確認ください。
              </p>
            </div>
            <button
          ...
          <div className="space-y-4 text-center">
            <div>
              <p className="text-gray-700 mb-1">
                💳 We also accept Japanese Yen Domestic Bank Transfer
              </p>
              <p className="text-gray-600">
                日本円での国内銀行振込も受け付けています
              </p>
            </div>
            <div>
              <a 
                href="mailto:support@jmichi.com"
